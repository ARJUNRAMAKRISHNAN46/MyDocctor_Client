...
import { doctorGoogle, signupDoctor } from "../../redux/actions/AuthActions";
...
function SignupComp() {
  ...
  const handleSubmit = async (values: FormValues) => {
    try {
      ...
      dispatch(signupDoctor(values)).then((res) => {
          ...
          <div className="md:w-[50%] h-[100vh] flex items-center hidden md:block">
            <div className="bg-violet-500 h-full rounded-br-[600px] flex justify-center items-center">
              <div>
                ...
                <div className="flex justify-center mt-8">
                  <h1 onClick={handleRoute} className="text-white hover:border border-white px-6 py-1">Register as a User</h1>
                </div>
              </div>
            </div>
          </div>
