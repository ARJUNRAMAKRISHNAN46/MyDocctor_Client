  ...
  return (
    <div>
      <div className="grid md:grid-cols-4 md:px-20">
        ...
        <div className="bg-white shadow-2xl m-4 p-4">
          <h1 className="text-blue-900 font-bold text-2xl">Appointment</h1>
          <p className="text-gray-600 text-sm">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis
            aute irure dolor in reprehenderit Asperiores dolores sed et. Tenetur
        ...
        <div className="bg-white shadow-2xl m-4 p-4">
          <h1 className="text-blue-900 font-bold text-2xl">Emergency Cases</h1>
          <p className="text-gray-600 text-sm">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis
            aute irure dolor in reprehenderit Asperiores dolores sed et. Tenetur
        ...
        <div className="bg-white shadow-2xl m-4 p-4">
          <h1 className="text-blue-900 font-bold text-2xl">Working Hours</h1>
          <p className="text-gray-600 text-sm">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis
            aute irure dolor in reprehenderit Asperiores dolores sed et. Tenetur
