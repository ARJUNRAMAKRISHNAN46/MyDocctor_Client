    ...
    <div>
      ...
      <div className="grid md:grid-cols-5 grid-cols-2 px-6 bg-red-50 md:px-72">
        <div>
          ...
          <h1 className="text-center md:mt-4 md:mb-28 font-semibold text-gray-600 ">Urology</h1>
        </div>
        <div>
          <div className="rounded-full hover:scale-105 p-10 m-4 md:mt-28 bg-white shadow-2xl">
            <img className="image-fluid "
          ...
          <h1 className="text-center mt-4 md:mb-28 font-semibold text-gray-600 ">Neurology</h1>
        </div>
        <div>
          <div className="rounded-full hover:scale-105 p-10 m-4 md:mt-28 bg-white shadow-2xl">
            <img className="image-fluid "
          ...
          <h1 className="text-center mt-4 md:mb-28 font-semibold text-gray-600 ">Orthopedic</h1>
        </div>
        <div>
          <div className="rounded-full hover:scale-105 p-10 m-4 md:mt-28 bg-white shadow-2xl">
            <img className="image-fluid "
          ...
          <h1 className="text-center mt-4 md:mb-28 font-semibold text-gray-600 ">Cardiologist</h1>
        </div>
        <div>
          <div className="rounded-full hover:scale-105 p-10 m-4 md:mt-28 bg-white shadow-2xl">
            <img className="image-fluid "
          ...
          <h1 className="text-center mt-4 md:mb-28 font-semibold text-gray-600 ">Dentist</h1>
        </div>
      </div>
    </div>
  );
