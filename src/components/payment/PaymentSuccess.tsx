    ...
    if (storedBookingData) {
      ...
      const savePayment = async () => {
        try {
          ...
          const paymentResponse = await axios.post(
            "https://mydocctor-server-7.onrender.com/payments/api/save-payment",
            bookingData
          );
          ...
          const appResponse = await axios.post(
            "https://mydocctor-server-7.onrender.com/appointment/api/update-appoinment",
            bookingData
          );
      ...
      const sendMail = async () => {
        try {
          ...
          const response = await axios.post(
            "https://mydocctor-server-7.onrender.com/notification/api/mail/send-mail",
            {
              email: userData?.email,
              message: "Appointment Booked Successfully",
            }
